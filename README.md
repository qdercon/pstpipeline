...
The easiest way to interactively play around with the dataset and replicate the results is to open the Jupyter notebooks in Google Colabatory (click on the button above). The majority of the code can be run completely on the cloud with no downloads necessary. 
